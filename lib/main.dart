...
class HvacApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'AGL - Flutter HVAC',
      theme: ThemeData(
        primarySwatch: Colors.green,
        primaryColor: Colors.green,
      ),
      home: const MainPage(title: 'AGL - Flutter HVAC'),
    );
  }
}
...
class _TemperatureSelector extends StatefulWidget {
  @override
  __TemperatureSelectorState createState() => __TemperatureSelectorState();
}

class __TemperatureSelectorState extends State<_TemperatureSelector> {
